...
```{r load_pkgs, echo=FALSE, warnings = FALSE, messages=FALSE}
library(neo4r)
library(dplyr)
library(jsonlite)
library(igraph)
...
```{r dc_count, echo=FALSE, warnings = FALSE, messages=FALSE}
...
```{r repo_count, echo=FALSE, warnings = FALSE, messages=FALSE}
...
```{r kword_tab, echo=FALSE, warnings = FALSE, messages=FALSE}
...
```{r dbl_link, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r githubusers, , echo=FALSE, warning=FALSE, message=FALSE}
...
```{r users_repos, echo=FALSE, warning=FALSE, message=FALSE}
